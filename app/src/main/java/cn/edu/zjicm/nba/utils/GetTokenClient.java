...
public class GetTokenClient {
	  ...
	  public static void get(RequestParams params, AsyncHttpResponseHandler responseHandler, String device) {
	  ...
	  public static void put(RequestParams params, AsyncHttpResponseHandler responseHandler){
